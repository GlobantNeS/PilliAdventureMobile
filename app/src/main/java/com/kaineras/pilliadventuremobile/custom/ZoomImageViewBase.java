...
public abstract class ZoomImageViewBase extends UrlImageView {
    ...
    /**
     * Use this to change the {@link ZoomImageViewBase#setDisplayType(DisplayType)} of
     * this View
     */
    ...
    public ZoomImageViewBase(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public ZoomImageViewBase(Context context, AttributeSet attrs, int defStyle) {
